...
public class Magpie4 {
	...
	public String getResponse(String statement) {
		...
		if (findKeyword(statement, "no") >= 0) {
			response = "Come on now. Be positive";
		}
		else if (statement.indexOf("mother") >= 0
				|| statement.indexOf("father") >= 0
				|| statement.indexOf("sister") >= 0
				|| statement.indexOf("brother") >= 0) {
			response = "Let me know more about your family!";
		}
			...
			response = "Staying healthy and eating is important. McDonalds is the meal of champions";
		}
	...
	private String transformIWantSomethingStatement(String statement) {
		...
		return "Would you like to have " + restOfStatement + "?";
	}
